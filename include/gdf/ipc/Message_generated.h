...
inline MessageHeader (&EnumValuesMessageHeader())[5] {
  static MessageHeader values[] = {
    MessageHeader_NONE,
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::flatbuf::Schema *header_as_Schema() const {
    return header_type() == MessageHeader_Schema ? static_cast<const org::apache::arrow::flatbuf::Schema *>(header()) : nullptr;
  }
  ...
  const org::apache::arrow::flatbuf::Tensor *header_as_Tensor() const {
    return header_type() == MessageHeader_Tensor ? static_cast<const org::apache::arrow::flatbuf::Tensor *>(header()) : nullptr;
  }
