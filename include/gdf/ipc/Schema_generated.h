...
inline MetadataVersion (&EnumValuesMetadataVersion())[4] {
  static MetadataVersion values[] = {
    MetadataVersion_V1,
    MetadataVersion_V2,
    MetadataVersion_V3,
    MetadataVersion_V4
...
inline UnionMode (&EnumValuesUnionMode())[2] {
  static UnionMode values[] = {
    UnionMode_Sparse,
    UnionMode_Dense
  };
  return values;
...
inline Precision (&EnumValuesPrecision())[3] {
...
inline DateUnit (&EnumValuesDateUnit())[2] {
  static DateUnit values[] = {
    DateUnit_DAY,
...
inline TimeUnit (&EnumValuesTimeUnit())[4] {
...
inline IntervalUnit (&EnumValuesIntervalUnit())[2] {
  static IntervalUnit values[] = {
...
inline Endianness (&EnumValuesEndianness())[2] {
  static Endianness values[] = {
    Endianness_Little,
    Endianness_Big
  };
  return values;
...
struct MapBuilder {
  ...
  MapBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
